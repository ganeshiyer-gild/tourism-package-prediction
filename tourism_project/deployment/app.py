...
NumberOfTrips = st.number_input("Number of Trips", min_value=1, max_value=50, step=1)
Passport = st.selectbox("Passport (1 for yes, 0 for No)", ["0", "1"])
OwnCar = st.selectbox("Own Car (1 for yes, 0 for No)", ["0", "1"])
...
DurationOfPitch = st.number_input("Duration of Pitch", min_value=1, max_value=150, step=1)
